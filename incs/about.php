                    ...
                    <div class="col-xs-12">
                        <div class="htc__bst__construc">
                            <div class="section__title text-center">
                                <h2 class="title__line">YOU ARE ONLY AS GOOD AS THE COMPANY YOU KEEP, AND HERE WE HAVE SOME PRETTY HIGH STANDARDS FOR YOU AT TALON CONSTRUCTIONS.</h2>
                                <p>Everyone on our team works hard, demonstrates honesty, show dedication, master ship of skills, integrity and pride in their work, and maintains a good sense of humor and readiness to do what it takes to get the job done right.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-9 col-lg-5 col-sm-7 col-xs-12">
                        <div class="htc__mission__container">
                            ...
                            <div class="single__mission">
                                <h2>OUR MISSION</h2>
                                <p>TALON Construction proposes to satisfy client requirements and exigencies on the market through accomplishment of complex projects of private, institutional and public constructions, at highest technological and quality level, strictly complying with the undertaken execution terms, continuous development of the organization environment where the employees perform, complying with environmental responsibility and permanent improving corporate sustainability standards.</p>
                            </div>
                        </div>
                    </div>
                </div>
